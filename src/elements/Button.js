...
const ElButton = styled.button`
  ...
  ${(props) =>
    props.chat
      ? `position: fixed; bottom: 14.81vh; right: 16.67vw; box-shadow: rgba(0,219,154,0.2) 0px 8px 24px; display:flex; align-items: center;justify-content: center; z-index: 100;`
      : null}
  ${(props) =>
